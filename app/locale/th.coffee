...
#    classroom_in_box_blurb4: ""
    covid19_banner_blurb: "เราเสนอให้นักเรียนและโรงเรียนที่ได้รับผลกระทบจากการปิดโรงเรียนสามารถเข้าถึงหลักสูตรทั้งหมดได้ฟรี."
    ...
    top_banner_blurb: "ผู้ปกครองจองคลาสเรียนเขียนโค้ดออนไลน์แบบต่อหน้าครั้งแรกของบุตรหลานฟรี!"
    try_the_game: "ลองเกม"
    ...
    student: "นักเรียน"
    our_coding_programs: "โปรแกรมการเข้าโค้ดของเรา"
#    codecombat: "CodeCombat"
#    ozaria: "Ozaria"
    codecombat_blurb: "เกมการเข้ารหัสดั้งเดิมของเรา แนะนำสำหรับผู้ปกครองบุคคลทั่วไปนักเรียนและนักศึกษาที่ต้องการสัมผัสกับหนึ่งในเกมเขียนโค้ดที่เป็นที่ชื่นชอบมากที่สุดในโลก"
